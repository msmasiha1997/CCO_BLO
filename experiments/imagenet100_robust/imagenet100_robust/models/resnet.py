...
class ResNet(nn.Module):
    def __init__(self, block: Callable[..., nn.Module], layers: list[int], cfg: ResNetConfig) -> None:
        super().__init__()
        self.inplanes = 64
...
def resnet50(num_classes: int = 100) -> ResNet:
    return ResNet(Bottleneck, [3, 4, 6, 3], ResNetConfig(num_classes=num_classes))


def resnet18(num_classes: int = 100) -> ResNet:
    return ResNet(BasicBlock, [2, 2, 2, 2], ResNetConfig(num_classes=num_classes))
